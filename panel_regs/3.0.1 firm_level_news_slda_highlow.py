...
train = ftdata[ftdata.highlow_lags_include != 0]
...
K = topicnumber
D = len(doc.stems)
y = np.asarray(train.highlow_lags_residual)
...
test_output['highlow_lags_residuals'] = np.asarray(ftdata.highlow_lags_residual)


export_filename = source_location + "/company_highlow_slda_30proportions_full.csv"
